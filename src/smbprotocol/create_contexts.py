...
class CreateContextName:
    ...
    SMB2_CREATE_APP_INSTANCE_ID = b"\x45\xbc\xa6\x6a\xef\xa7\xf7\x4a" b"\x90\x08\xfa\x46\x2e\x14\x4d\x74"  # fmt: skip
    SMB2_CREATE_APP_INSTANCE_VERSION = (
        b"\xb9\x82\xd0\xb7\x3b\x56\x07\x4f"
        b"\xa0\x7b\x52\x4a\x81\x16\xa0\x10"
    )  # fmt: skip
    SVHDX_OPEN_DEVICE_CONTEXT = b"\x9c\xcb\xcf\x9e\x04\xc1\xe6\x43" b"\x98\x0e\x15\x8d\xa1\xf6\xec\x83"  # fmt: skip
