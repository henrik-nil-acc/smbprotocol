...
class CreateContextName:
    ...
    SMB2_CREATE_EA_BUFFER = b"ExtA"

    # note: the structures for this are located in security_descriptor.py
    SMB2_CREATE_SD_BUFFER = b"SecD"
    SMB2_CREATE_DURABLE_HANDLE_REQUEST = b"DHnQ"
    SMB2_CREATE_DURABLE_HANDLE_RECONNECT = b"DHnC"
    SMB2_CREATE_ALLOCATION_SIZE = b"AlSi"
    SMB2_CREATE_QUERY_MAXIMAL_ACCESS_REQUEST = b"MxAc"
    SMB2_CREATE_TIMEWARP_TOKEN = b"TWrp"
    SMB2_CREATE_QUERY_ON_DISK_ID = b"QFid"
    SMB2_CREATE_REQUEST_LEASE = b"RqLs"
    SMB2_CREATE_REQUEST_LEASE_V2 = b"RqLs"
    SMB2_CREATE_DURABLE_HANDLE_REQUEST_V2 = b"DH2Q"
    SMB2_CREATE_DURABLE_HANDLE_RECONNECT_V2 = b"DH2C"
    ...
    def __init__(self):
        self.fields = OrderedDict(
            [
                ...
                ("data_offset", IntField(size=2, default=SMB2CreateContextRequest._buffer_data_offset)),
